    ...
    <div className="">
      ...
      <div className="bg-white ml-8 mr-8 ">
        <table className="table-auto text-xs  w-full text-left ">
          <thead>
            <tr className="h-14 border-b text-left text-sm tracking-wide ">
              <th className=" w-2/6 pl-16 font-medium text-base">Date</th>
              <th className=" w-3/6 font-medium text-base">Link</th>
              <th className=" w-1/6 font-medium text-base">Status</th>
            </tr>
          </thead>
          <tbody>
