...
import VIewTrackAlbum from "./ViewTrackAlbums";
import ViewAlbumStores from "./ViewAlbumStores";
    ...
    return (
      <div>
          ...
          <div className="py-3">
            ...
            {show ? (
              <ul className="absolute bg-white w-64 rounded font-Light shadow-lg  border cursor-pointer">
                <li className="h-8 pl-5 p-2 hover:bg-hover ">
                  <a href={album?.coverImage} className="" target="blank">
                    Download Artwork
                  </a>
                </li>
                <li className="h-6 pl-5  hover:bg-hover">
                ...
                <li
                  ...
                  className="h-6 pl-5  hover:bg-hover"
                >
                  InReview Release
                </li>
                <li
        ...
        <div className="bg-background min-h-screen p-10">
          ...
          {tab === 3 ? <ViewAlbumStores id={params.id} /> : null}
